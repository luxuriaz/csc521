...
def FunctionDeclaration0(pt, scope):
    ...
    params_names = func_by_name(pt[4][0],pt[4],scope)
    scope[function_name] = [params_names,pt[6]]
...
def FunctionCall0(pt, scope):
    ...
    '''
    functionscope = {"__parent__":scope}
    value_name = func_by_name(pt[1][0],pt[1],scope)
    value = value_name[0]
    name = value_name[1]
    index = int(func_by_name(pt[5][0],pt[5],scope))
    param_value = func_by_name(pt[3][0],pt[3],scope)
    param_name = value[0]
    for i in len(param_value):
        scope[param_name[i]] = param_value[i]
    return func_by_name(value_name[1][0],func_by_name[1],functionscope)[index]
...
def functionCall1(pt, scope):
    ...
    for i in len(param_value):
        scope[param_name[i]] = param_value[i]
    return func_by_name(value_name[1][0],func_by_name[1],functionscope)
...
if __name__ == '__main__':
    ...
    program_scope={}
    print (str(func_by_name(tree[0],tree,scope)))
